...
public class Globals : MonoBehaviour
{
    public Dictionary<string, ItemType> itemCombinations = new Dictionary<string, ItemType>()
    {
        ...
        {"JASMYNG_TEA_LEAVES+FISH_EGG_MILK", ItemType.JASMYNG_FISH_EGG_MILK_TEA},
        {"CEYLONG_TEA_LEAVES+FISH_EGG_MILK", ItemType.CEYLONG_FISH_EGG_MILK_TEA},
        {"BOLONG_TEA_LEAVES+FISH_EGG_MILK", ItemType.BOLONG_FISH_EGG_MILK_TEA},
        {"PAROOT_TEA_LEAVES+FISH_EGG_MILK", ItemType.PAROOT_FISH_EGG_MILK_TEA}
    };
